...
export default function Flexibility() {
  return (
    <div
      className="container mx-auto md:max-w-3xl lg:max-w-5xl md:w-3/4 py-16
    ...
    >
      <div className="grid justify-center pb-6 md:pb-0">
        <div className="flex items-end gap-2">
          <div className="relative">
            <img
              src={unsplashnEtpvJjnPVo}
              alt=""
              className="object-cover rounded-xl"
            />
            <h3 className="absolute top-2 left-6 text-white">
              Flexible Leases
            </h3>
          </div>
          <div className="relative">
            <img src={Image2} alt="" className="object-cover  rounded-xl" />
            <h3 className="absolute top-2 left-[3%] text-white text-center">
      ...
      <div className="grid pt-6 lg:pt-0  lg:flex lg:flex-col lg:gap-3 justify-center items-center">
        ...
        <p
          className="text-sm leading-6 pt-1 pb-4
            w-11/12 md:w-full mx-auto md:mx-0"
        >
